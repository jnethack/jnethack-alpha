...
-- Hippocrates
des.monster({ id = "ヒポクラテス", coord = {37, 10}, inventory = function()
   des.object({ id = "銀の短剣", spe = 5 });
end })
-- The treasure of Hippocrates
des.object("宝箱", 37, 10)
-- intern guards for the audience chamber
des.monster("随行員", 29, 08)
des.monster("随行員", 29, 09)
des.monster("随行員", 29, 10)
des.monster("随行員", 29, 11)
des.monster("随行員", 40, 09)
des.monster("随行員", 40, 10)
des.monster("随行員", 40, 11)
des.monster("随行員", 40, 13)
-- Non diggable walls
