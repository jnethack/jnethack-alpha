...
-- Objects
des.object({ id = "鏡", x=50,y=06, buc="blessed", spe=0, name="マーリンの魔法の鏡" })
...
des.trap()
-- Random monsters.
des.monster({ id = "イクソス", x=50, y=06, peaceful=0 })
des.monster({ id = "クアシト", peaceful=0 })
des.monster({ id = "クアシト", peaceful=0 })
des.monster({ id = "クアシト", peaceful=0 })
des.monster({ id = "クアシト", peaceful=0 })
des.monster({ id = "クアシト", peaceful=0 })
...
des.monster({ class = "i", peaceful=0 })
des.monster({ id = "黄土色ゼリー", peaceful=0 })
des.monster({ id = "黄土色ゼリー", peaceful=0 })
des.monster({ id = "黄土色ゼリー", peaceful=0 })
des.monster({ id = "黄土色ゼリー", peaceful=0 })
des.monster({ id = "黄土色ゼリー", peaceful=0 })
