...
des.trap()
-- Random monsters.
des.monster({ id = "忍者", x=15, y=05, peaceful=0 })
des.monster({ id = "忍者", x=16, y=05, peaceful=0 })
des.monster("狼", 17, 05)
des.monster("狼", 18, 05)
des.monster({ id = "忍者", x=19, y=05, peaceful=0 })
des.monster("狼", 15, 14)
des.monster("狼", 16, 14)
des.monster({ id = "忍者", x=17, y=14, peaceful=0 })
des.monster({ id = "忍者", x=18, y=14, peaceful=0 })
des.monster("狼", 56, 05)
des.monster({ id = "忍者", x=57, y=05, peaceful=0 })
des.monster("狼", 58, 05)
des.monster("狼", 59, 05)
des.monster({ id = "忍者", x=56, y=14, peaceful=0 })
des.monster("狼", 57, 14)
des.monster({ id = "忍者", x=58, y=14, peaceful=0 })
des.monster("d", 59, 14)
des.monster("狼", 60, 14)
des.monster("ストーカー")
des.monster("ストーカー")
...
des.monster({ id = "侍", x=30, y=05, peaceful=0 })
des.monster({ id = "侍", x=31, y=05, peaceful=0 })
des.monster({ id = "侍", x=32, y=05, peaceful=0 })
des.monster({ id = "侍", x=32, y=14, peaceful=0 })
des.monster({ id = "侍", x=33, y=14, peaceful=0 })
des.monster({ id = "侍", x=34, y=14, peaceful=0 })
