...
if percent(50) then
   des.monster({ id = "クロイソス", x=43, y=10, peaceful = 0 })
else
   des.monster({ id = "クロイソス", x=43, y=09, peaceful = 0 })
   des.terrain(43,09, "\\")
   des.terrain(43,10, ".")
end
if percent(50) then
...
des.monster("兵士",12,14)
des.monster("兵士",12,13)
des.monster("兵士",11,10)
des.monster("兵士",13,02)
des.monster("兵士",14,03)
des.monster("兵士",20,02)
des.monster("兵士",30,02)
des.monster("兵士",40,02)
des.monster("兵士",30,16)
des.monster("兵士",32,16)
des.monster("兵士",40,16)
des.monster("兵士",54,16)
des.monster("兵士",54,14)
des.monster("兵士",54,13)
des.monster("兵士",57,10)
des.monster("兵士",57,09)
des.monster("副官",15,08)
-- Possible source of a boulder
des.monster("岩石巨人",03,01)
...
des.monster("D",33,14)
-- Eels in the moat
des.monster("巨大ウナギ",17,08)
des.monster("巨大ウナギ",17,11)
des.monster("巨大ウナギ",48,08)
des.monster("巨大ウナギ",48,11)
-- The corner rooms treasures
des.object("ダイヤモンド",19,06)
des.object("ダイヤモンド",20,06)
des.object("ダイヤモンド",21,06)
des.object("エメラルド",19,13)
des.object("エメラルド",20,13)
des.object("エメラルド",21,13)
des.object("ルビー",46,06)
des.object("ルビー",47,06)
des.object("ルビー",48,06)
des.object("アメジスト",46,13)
des.object("アメジスト",47,13)
des.object("アメジスト",48,13)
