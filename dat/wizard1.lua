...
----------------------------x
   ...
   des.monster({ id = "イェンダーの魔法使い", x=16, y=05, asleep=1 })
   des.monster("ヘルハウンド", 15, 05)
   des.monster("吸血鬼の貴族", 17, 05)
   -- The local treasure
   des.object("死者の書", 16, 05)
   -- Surrounding terror
   des.monster("クラーケン", 14, 02)
   des.monster("巨大ウナギ", 17, 02)
   des.monster("クラーケン", 13, 04)
   des.monster("巨大ウナギ", 13, 06)
   des.monster("クラーケン", 19, 04)
   des.monster("巨大ウナギ", 19, 06)
   des.monster("クラーケン", 15, 08)
   des.monster("巨大ウナギ", 17, 08)
   des.monster("ピラニア", 15, 02)
   des.monster("ピラニア", 19, 08)
   -- Random monsters
   des.monster("D")
   des.monster("H")
   des.monster("&")
