...
des.object({ id = "宝箱", trapped = 0, locked = 1, coord = loc ,
             contents = function()
                des.object("願いの杖");
                des.object("レベルアップの薬");
             end
...
des.object({ id = "怪物を怯えさせる巻物", coord = loc, buc="cursed" })
...
des.monster("兵士",08,06)
des.monster("兵士",09,05)
des.monster("兵士",11,05)
des.monster("兵士",12,06)
des.monster("兵士",08,10)
des.monster("兵士",09,11)
des.monster("兵士",11,11)
des.monster("兵士",12,10)
des.monster("副官",09,08)
-- Soldiers guarding the towers
des.monster("兵士",03,02)
des.monster("兵士",05,02)
des.monster("兵士",57,02)
des.monster("兵士",59,02)
des.monster("兵士",03,14)
des.monster("兵士",05,14)
des.monster("兵士",57,14)
des.monster("兵士",59,14)
...
des.monster("巨大ウナギ",05,07)
des.monster("巨大ウナギ",05,09)
des.monster("巨大ウナギ",57,07)
des.monster("巨大ウナギ",57,09)
des.monster("サメ",05,00)
des.monster("サメ",05,16)
des.monster("サメ",57,00)
des.monster("サメ",57,16)
