...
-- Objects
des.object({ id = "水晶玉", x=17, y=08, buc="blessed", spe=5, name="運命のオーブ" })
des.object()
des.object()
des.object()
des.object()
...
des.monster("a")
des.monster("a")
des.monster({ id = "炎の巨人", x=10, y=06, peaceful = 0 })
des.monster({ id = "炎の巨人", x=10, y=07, peaceful = 0 })
des.monster({ id = "炎の巨人", x=10, y=08, peaceful = 0 })
des.monster({ id = "炎の巨人", x=10, y=09, peaceful = 0 })
des.monster({ id = "炎の巨人", x=10, y=10, peaceful = 0 })
des.monster({ id = "炎の巨人", x=24, y=06, peaceful = 0 })
des.monster({ id = "炎の巨人", x=24, y=07, peaceful = 0 })
des.monster({ id = "炎の巨人", x=24, y=08, peaceful = 0 })
des.monster({ id = "炎の巨人", x=24, y=09, peaceful = 0 })
des.monster({ id = "炎の巨人", x=24, y=10, peaceful = 0 })
des.monster({ id = "炎の巨人", peaceful = 0 })
des.monster({ id = "炎の巨人", peaceful = 0 })
