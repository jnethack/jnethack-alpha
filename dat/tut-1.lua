...
des.object({ coord = { 41,6 }, id = "大箱", broken = true, trapped = false,
...
des.object({ coord = { 50,3 }, id = "死体", montype = "苔の怪物", buc = "not-cursed" });
...
des.object({ id = "岩", coord = {71,16} });
des.object({ id = "岩", coord = {72,16} });
des.object({ id = "岩", coord = {73,16} });
...
des.object({ coord = { 57,2 }, id = "灯りの魔法書", buc = "blessed" });
...
des.object({ coord = { 72,2 }, id = "物体を探す薬", buc = "blessed" });
