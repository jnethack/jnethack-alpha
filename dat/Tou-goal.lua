...
des.door("open",59,17)
-- Objects
des.object({ id = "クレジットカード", x=04, y=01, buc="blessed", spe=0, name="プラチナイェンダー印エクスプレスカード" })
des.object()
des.object()
des.object()
des.object()
...
-- Random monsters.
des.monster({ id = "盗賊の頭領", x=04, y=01, peaceful = 0 })
des.monster("巨大グモ")
des.monster("巨大グモ")
des.monster("巨大グモ")
des.monster("巨大グモ")
...
des.monster("サキュバス", 02, 08)
des.monster("サキュバス", 08, 08)
des.monster("インキュバス", 02, 14)
des.monster("インキュバス", 08, 14)
des.monster("インキュバス", 02, 17)
des.monster("インキュバス", 08, 17)
-- Police station (with drunken prisoners)
des.monster({ id = "警部補", x=24, y=09, peaceful = 0 })
des.monster({ id = "巡査部長", x=20, y=09, peaceful = 0 })
des.monster({ id = "巡査部長", x=22, y=11, peaceful = 0 })
des.monster({ id = "巡査部長", x=22, y=07, peaceful = 0 })
des.monster({ id = "警備員", x=19, y=07, peaceful = 0 })
des.monster({ id = "警備員", x=19, y=08, peaceful = 0 })
des.monster({ id = "警備員", x=22, y=09, peaceful = 0 })
des.monster({ id = "警備員", x=24, y=11, peaceful = 0 })
des.monster({ id = "警備員", x=19, y=11, peaceful = 0 })
des.monster("囚人", 19, 13)
des.monster("囚人", 21, 13)
des.monster("囚人", 24, 13)
--
des.monster({ id = "見張り", x=33, y=10, peaceful = 0 })
