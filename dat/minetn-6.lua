...
des.monster("ドワーフ")
des.monster("ドワーフ")
des.monster({ id = "ドワーフ", peaceful = 1 })
des.monster({ id = "ドワーフ", peaceful = 1 })
des.monster({ id = "ノーム", peaceful = 1 })
des.monster({ id = "ノーム", peaceful = 1 })
des.monster({ id = "ホビット", peaceful = 1 })
des.monster({ id = "ゴブリン", peaceful = 1 })
des.monster({ id = "コボルド", peaceful = 1 })
des.monster({ id = "犬", peaceful = 1 })
