...
--
des.object({ id="死体",montype="考古学者" })
des.object({ id="死体",montype="考古学者" })
des.object({ id="死体",montype="野蛮人" })
des.object({ id="死体",montype="野蛮人" })
des.object({ id="死体",montype="洞窟人" })
des.object({ id="死体",montype="洞窟人" })
des.object({ id="死体",montype="薬師" })
des.object({ id="死体",montype="薬師" })
des.object({ id="死体",montype="騎士" })
des.object({ id="死体",montype="騎士" })
des.object({ id="死体",montype="レンジャー" })
des.object({ id="死体",montype="レンジャー" })
des.object({ id="死体",montype="盗賊" })
des.object({ id="死体",montype="盗賊" })
des.object({ id="死体",montype="侍" })
des.object({ id="死体",montype="侍" })
des.object({ id="死体",montype="観光客" })
des.object({ id="死体",montype="観光客" })
des.object({ id="死体",montype="ワルキューレ" })
des.object({ id="死体",montype="ワルキューレ" })
des.object({ id="死体",montype="魔法使い" })
des.object({ id="死体",montype="魔法使い" })
--
