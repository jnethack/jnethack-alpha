...
-- Shaman Karnov
des.monster({ id = "呪術師カルノフ", coord = {35, 02}, inventory = function()
   des.object({ id = "革鎧", spe = 5 });
   des.object({ id = "こん棒", spe = 5 });
end })
-- The treasure of Shaman Karnov
des.object("宝箱", 34, 02)
-- neanderthal guards for the audience chamber
des.monster("ネアンデルタール人", 20, 03)
des.monster("ネアンデルタール人", 20, 02)
des.monster("ネアンデルタール人", 20, 01)
des.monster("ネアンデルタール人", 21, 03)
des.monster("ネアンデルタール人", 21, 02)
des.monster("ネアンデルタール人", 21, 01)
des.monster("ネアンデルタール人", 22, 01)
des.monster("ネアンデルタール人", 26, 09)
-- Non diggable walls
...
des.monster({ id ="バグベアー", x=47, y=02, peaceful=0 })
des.monster({ id ="バグベアー", x=48, y=03, peaceful=0 })
des.monster({ id ="バグベアー", x=49, y=04, peaceful=0 })
des.monster({ id ="バグベアー", x=67, y=03, peaceful=0 })
des.monster({ id ="バグベアー", x=69, y=04, peaceful=0 })
des.monster({ id ="バグベアー", x=51, y=13, peaceful=0 })
des.monster({ id ="バグベアー", x=53, y=14, peaceful=0 })
des.monster({ id ="バグベアー", x=55, y=15, peaceful=0 })
des.monster({ id ="バグベアー", x=63, y=10, peaceful=0 })
des.monster({ id ="バグベアー", x=65, y=09, peaceful=0 })
des.monster({ id ="バグベアー", x=67, y=10, peaceful=0 })
des.monster({ id ="バグベアー", x=69, y=11, peaceful=0 })
des.wallify()
