...
const struct Role roles[] = {
    ...
    { { "çlå√äwé“", 0 },
      { { "çzàı", 0 },
        ...
        { "î¸èpé˚èWé“", 0 },
        { "äŸí∑", 0 } },
      "ÉPÉcÉAÉãÉJÉgÉã", "ÉJÉ}ÉLÉVÉgÉä", "ÉtÉwÉgÉgÉã", /* Central American */
#endif
      "Arc",
#if 0 /*JP*/
    ...
    { { "ãRém", 0 },
      { { "å©èKÇ¢", 0 },
        ...
        { "åMãRém", 0 },
        { "êπãRém", 0 } },
      "ÉãÅ[Ét", "_ÉuÉäÉWÉbÉg", "É}ÉiÉìÉiÉìÅEÉ}ÉNÉäÅ[Éã", /* Celtic */
#endif
      "Kni",
#if 0 /*JP*/
      "Camelot Castle",
    ...
    { { "äœåıãq", 0 },
      { { "ÉvÅ[ëæòY", "ÉvÅ[éq" },
        ...
        { "íTåüâ∆", 0 },
        { "ñ`åØé“", 0 } },
      "ñ”ñ⁄ÇÃÉCÉç", "_ÅÉèóê_ÅÑ", "ÉIÉtÉâÅ[", /* Discworld */
#endif
      "Tou",
#if 0 /*JP*/
      "Ankh-Morpork",
    ...
    { { "ÉèÉãÉLÉÖÅ[Éå", 0 },
      { { "å©èKÇ¢", 0 },
        ...
        { "êÊì±é“", 0 },
        { "ÉçÅ[Éh", "ÉåÉfÉB" } },
      "É`ÉÖÅ[Éã", "ÉIÅ[ÉfÉBÉì", "ÉçÉL", /* Norse */
#endif
      "Val",
#if 0 /*JP*/
