...
const struct Role roles[] = {
    ...
    { { "Ž˜", 0 },
      { { "Šø–{", 0 },       /* Banner Knight */
        { "˜Ql", 0 },          /* no allegiance */
        { "”EŽÒ", "‚­ƒmˆê" }, /* secret society */
        { "éŽå", 0 },          /* heads a castle */
        { "—ÌŽå", 0 },         /* has a territory */
        { "—ÌŽå", 0 },        /* heads a province */
        { "‘å–¼", "˜Œ³" },         /* a samurai lord */
...
/*JP:
- steed.c kick_steed() He[] ‚É’l‚ªƒRƒs[‚³‚ê‚é‚Ì‚Å’·‚³‚ð•Ï‚¦‚½‚Æ‚«‚É‚Í
  ŠY“–•”‚à—vC³B
*/
...
#else
    { "’j«", "”Þ", "”Þ", "”Þ‚Ì", "Mal", ROLE_MALE },
    { "—«", "”Þ—", "”Þ—", "”Þ—‚Ì", "Fem", ROLE_FEMALE },
