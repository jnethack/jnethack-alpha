...
#define SPINACH 2
...
#else
        } else if (!STRNCMPEX(bp, "呪われた")) {
#endif
            iscursed = 1;
#if 0 /*JP:T*/
        } else if (!strncmpi(bp, "uncursed ", l = 9)) {
#else
        } else if (!STRNCMPEX(bp, "呪われていない")) {
#endif
            uncursed = 1;
#if 0 /*JP:T*/
...
#else
        } else if (!STRNCMPEX(bp, "食べかけの")) {
#endif
            halfeaten = 1;
#if 0 /*JP:T*/
        } else if (!strncmpi(bp, "historic ", l = 9)) {
#else
        } else if (!STRNCMPEX(bp, "歴史的な")) {
#endif
            ishistoric = 1;
#if 0 /*JP:T*/
        } else if (!strncmpi(bp, "diluted ", l = 8)) {
#else
        } else if (!STRNCMPEX(bp, "薄まった")) {
#endif
            isdiluted = 1;
#if 0 /*JP:T*/
        } else if (!strncmpi(bp, "empty ", l = 6)) {
#else
        } else if (!STRNCMPEX(bp, "空っぽの")) {
#endif
            contents = EMPTY;
#if 0 /*JP:T*/
        } else if (!strncmpi(bp, "small ", l = 6)) { /* glob sizes */
#else
        } else if (!STRNCMPEX(bp, "小さい")) { /* glob sizes */
#endif
...
#else
    {
        ...
        int l = strlen(bp);
        int l2 = strlen("の塊");
        if (l > 4 && strncmp(bp + l - l2, "の塊", l2) == 0) {
