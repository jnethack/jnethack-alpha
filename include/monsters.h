 ...
 */
    ...
    MON(NAM("バグベアー"), S_HUMANOID,
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION,
        5, CLR_BROWN, BUGBEAR),
    MON(NAMS("ドワーフの貴族", "ドワーフの貴族", "ドワーフの貴族"), S_HUMANOID,
    ...
    MON(NAMS("ドワーフの王", "ドワーフの女王", "ドワーフの王"),
    ...
    MON(NAM("マスターマインドフレア"), S_HUMANOID,
    ...
    MON(NAMS("コボルドの貴族", "コボルドの貴族", "コボルドの貴族"), S_KOBOLD,
    ...
    MON(NAM("ゴブリン"), S_ORC,
        ...
        1, CLR_GRAY, GOBLIN),
    MON(NAM("ホブゴブリン"), S_ORC, LVL(1, 9, 10, 0, -4), (G_GENO | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON(NAM("吸血こうもり"), S_BAT, LVL(5, 20, 6, 0, 0), (G_GENO | 2),
...
#if 0 /* DEFERRED */
    MON(NAM("ボーパルジャバウォック"), S_JABBERWOCK,
    ...
    MON(NAM("オーガ"), S_OGRE,
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION,
        7, CLR_BROWN, OGRE),
    MON(NAMS("オーガの貴族", "オーガの貴族", "オーガの貴族"), S_OGRE,
    ...
    MON(NAMS("オーガの王", "オーガの女王", "オーガの王"), S_OGRE,
    ...
    MON(NAM("吸血鬼"), S_VAMPIRE,
        ...
        M3_INFRAVISIBLE,
        12, CLR_RED, VAMPIRE),
    MON(NAMS("吸血鬼の貴族", "吸血鬼の貴族", "吸血鬼の貴族"), S_VAMPIRE,
     ...
     */
    MON(NAM("人間"), S_HUMAN, /* for corpses */
    ...
    MON(NAM("エルフ"), S_HUMAN, /* for corpses */
    ...
    MON(NAM("灰色エルフ"), S_HUMAN,
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION,
        8, CLR_GRAY, GREY_ELF),
    MON(NAMS("エルフの貴族", "エルフの貴族", "エルフの貴族"), S_HUMAN,
    ...
    MON(NAMS("エルフの王", "エルフの女王", "エルフの王"), S_HUMAN,
...
#define SEDUCTION_ATTACKS_NO \
    ...
    MON(NAMS("インキュバス", "サキュバス", "夢魔"), S_DEMON,
     ...
     */
    MON(NAM("ジョウビレックス"), S_DEMON, LVL(50, 3, -7, 65, -15),
    ...
    MON(NAM("勇者オリオン"), S_HUMAN, LVL(20, 15, 0, 90, 0), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 4, 10), ATTK(AT_MAGC, AD_SPEL, 4, 8),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON(NAM("大名佐藤"), S_HUMAN, LVL(20, 15, 0, 90, 20), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 4, 10), ATTK(AT_WEAP, AD_PHYS, 4, 10),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_LEADER, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
    ...
    MON(NAM("ナルゾク"), S_DEMON, LVL(16, 12, -2, 85, -127),
